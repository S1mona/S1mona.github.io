...
bracket_match<- function(s, i, indl, indr){
...
A Density,  `r rinline("res$tex[[4]]")`:

```{r, results='asis', echo=FALSE}
#problems with {{...}}
#{}\over{} should be \frac{}{}
#cat( res$tex[[4]], "\n")
x <- res$tex[[4]]%>%gsub(" ", "",.)%>%strsplit(., "*")%>%unlist
# sum(x=="}")
# sum(x=="{")
# y <- x[4:413]
# sum(y=="}")
...
inds <- which(x=="{")
#end of }
inde <- sapply(inds, function(i)x%>%bracket_match(., i+1, 1, 0))
...
# x%>%bracket_match(., 8, 1, 0)
# x%>%bracket_match(., 9, 1, 0)
# (res$tex[[4]]%>%gsub(" ", "",.)%>%strsplit(., "*")%>%unlist)[4]

# if(res$tex[[4]]%>%grepl("^\\$\\$(\\-|)\\{\\{", .)&res$tex[[4]]%>%grepl("\\}\\}\\$\\$$", .)){
#     res$tex[[4]]%>%gsub("^\\$\\$(\\-|)\\{\\{","$$\\1{",.)%>%gsub("\\}\\}\\$\\$$","}$$",.)%>%cat(.,  "\n")
# }#
x%>%paste0(., collapse="")%>%cat(.,  "\n")
#res$tex[[4]]%>%cat(.,  "\n")
```

<!-- $${\frac{e^{{\frac{\sigma_{1}^2\,y_{2}^2+\left(\left(2\,\mu_{1}\,\sigma_{1}-2\, \sigma_{1}\,y_{1}\right)\,\rho_{1,2}\,\sigma_{2}-2\,\sigma_{1}^2\, \mu_{2}\right)\,y_{2}+\left(y_{1}^2-2\,\mu_{1}\,y_{1}+\mu_{1}^2 \right)\,\sigma_{2}^2+\left(2\,\sigma_{1}\,y_{1}-2\,\mu_{1}\,\sigma _{1}\right)\,\rho_{1,2}\,\mu_{2}\,\sigma_{2}+\sigma_{1}^2\,\mu_{2}^2 }{2\,\left(\sigma_{1}^2\,\rho_{1,2}^2-\sigma_{1}^2\right)\, \sigma_{2}^2}}}}{2\,\pi\,\sqrt{\sigma_{1}^2-\sigma_{1}^2\,\rho _{1,2}^2}\,\left| \sigma_{2}\right| }}$$  -->


<!-- $${\frac{e^{\frac{\sigma_{1}^2\,y_{2}^2+\left(\left(2\,\mu_{1}\,\sigma_{1}-2\,\sigma_{1}\,y_{1}\right)\,\rho_{1,2}\,\sigma_{2}-2\,\sigma_{1}^2\,\mu_{2}\right)\,y_{2}+\left(y_{1}^2-2\,\mu_{1}\,y_{1}+\mu_{1}^2\right)\,\sigma_{2}^2+\left(2\,\sigma_{1}\,y_{1}-2\,\mu_{1}\,\sigma_{1}\right)\,\rho_{1,2}\,\mu_{2}\,\sigma_{2}+\sigma_{1}^2\,\mu_{2}^2}{2\,\left(\sigma_{1}^2\,\rho_{1,2}^2-\sigma_{1}^2\right)\,\sigma_{2}^2}}}{2\,\pi\,\sqrt{\sigma_{1}^2-\sigma_{1}^2\,\rho_{1,2}^2}\,\left|\sigma_{2}\right|}}$$ -->

BCAE: 

$${e^{{\sigma_{1}^2\,y_{2}^2+\left(\left(2\,\mu_{1}\,\sigma_{1}-2\,\sigma_{1}\,y_{1}\right)\,\rho_{1,2}\,\sigma_{2}-2\,\sigma_{1}^2\,\mu_{2}\right)\,y_{2}+\left(y_{1}^2-2\,\mu_{1}\,y_{1}+\mu_{1}^2\right)\,\sigma_{2}^2+\left(2\,\sigma_{1}\,y_{1}-2\,\mu_{1}\,\sigma_{1}\right)\,\rho_{1,2}\,\mu_{2}\,\sigma_{2}+\sigma_{1}^2\,\mu_{2}^2}\over{2\,\left(\sigma_{1}^2\,\rho_{1,2}^2-\sigma_{1}^2\right)\,\sigma_{2}^2}}}\over{2\,\pi\,\sqrt{\sigma_{1}^2-\sigma_{1}^2\,\rho_{1,2}^2}\,\left|\sigma_{2}\right|}$$ 
