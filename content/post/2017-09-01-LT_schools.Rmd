...
Happy school year! With a lot of of help from Rselenium, I did some Wikipedia scrapping and gathered a data set on Lithuanian schools. The data set does not cover all existing schools, but it gives a rough overview of the situation. According to [the ministry of education](http://www.svis.smm.lt/) where were 1151 schools in 2016-2017, so the data set covers about 80$\%$ of the total population.  
