---
title: "First instance decisions on applications by citizenship, age and sex Annual aggregated data"
...
dic <- lapply(c("citizen","sex","age","decision","geo","unit"), get_eurostat_dic)
```
